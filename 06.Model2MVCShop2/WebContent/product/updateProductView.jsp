...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input 	type="text" name="manuDate" value="${productVO.manuDate}" class="ct_input_g" 
							style="width:370px; height:19px"  maxLength="100">
			<a href="javascript:show_calendar('document.detailForm.manuDate', document.detailForm.manuDate.value);"><img src="/images/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the manufacture_day"></a>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">
						<input 	type="file" name="fileName" value="${productVO.fileName}" class="ct_input_g" 
										style="width:300px; height:19px" onChange="check_email(this.form);">
					</td>
				</tr>
			</table>
		</td>
