...
<table width="100%" height="37" border="0" cellpadding="0"	cellspacing="0">
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="93%" class="ct_ttl01">다음과같이 구매되었습니다.</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td class="ct_write01">${purchaseVO.purchaseProd.prodNo}</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">${purchaseVO.paymentOption}</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">${purchaseVO.divyAddr}</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">${purchaseVO.divyRequest}</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td width="104" class="ct_write">배송 희망일자 </td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">${purchaseVO.divyDate}</td>
				</tr>
			</table>
		</td>
	</tr>
